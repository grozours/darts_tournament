...
const buildSyntaxErrorContext = (error: Error): ErrorContext | undefined => {
...
const buildPrismaErrorContext = (error: Error): ErrorContext | undefined => {
...
const buildMulterErrorContext = (error: Error): ErrorContext | undefined => {
  if (error.name === 'MulterError') {
    ...
    switch (multerError.code) {
      ...
      case 'LIMIT_UNEXPECTED_FILE': {
        message = multerError.field && multerError.field !== 'logo'
          ? 'Invalid file field. Expected logo'
...
export const asyncHandler = (function_: AsyncHandler) => (
  request: Request,
  response: Response,
  next: NextFunction
) => {
