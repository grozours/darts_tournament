...
Darts Tournament Manager utiliza una estrategia de prueba integral que incluye pruebas unitarias, pruebas de integración, pruebas de contrato y pruebas de un extremo a otro.
...
- [Pruebas de back-end](#pruebas-de-back-end)
- [Pruebas de interfaz](#pruebas-de-interfaz)
- [Pruebas de un extremo a otro](#pruebas-de-un-extremo-a-otro)
...
| Tipo | Marco | Alcance | Velocidad | Cobertura |
|------|-----------|-------|-------|----------|
| **Unidad** | Broma/Vitest | Funciones/componentes individuales | Rápido | Alto |
| **Integración** | Broma + Prisma | Múltiples componentes trabajando juntos | Medio | Medio |
| **Contrato** | Broma | Contratos API y respuestas | Rápido | Medio |
| **E2E** | Dramaturgo | Flujos de trabajo de usuario completos | Lento | Bajo |
...
### Configuración de broma (`jest.config.js`)
...
#### Ejemplo: Prueba de unidad de servicio
...
Las pruebas de integración utilizan una base de datos de prueba y prueban interacciones reales de bases de datos.
...
Las pruebas de contrato verifican la estructura de respuesta de la API y los tipos de datos.
...
#### Ejemplo: Prueba de visualización de jugadores
...
#### Ejemplo: Prueba de etapas de piscina
...
### 2. Organizar-Actuar-Afirmar (AAA)
...
### 5. Burlarse de las dependencias externas
...
- No confíes en el orden de ejecución de la prueba.
- Limpiar después de cada prueba.
- Usar transacciones para pruebas de bases de datos.

### 7. Afirmaciones significativas
