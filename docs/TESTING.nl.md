...
De Darts Tournament Manager maakt gebruik van een uitgebreide teststrategie, waaronder unit-tests, integratietests, contracttests en end-to-end-tests.
...
- [Backend-testen](#backend-testen)
- [Frontend-testen](#frontend-testen)
- [End-to-end testen](#end-to-end-testen)
- [Testdekking](#testdekking)
- [CI/CD-integratie](#cicd-integratie)
...
| Typ | Kader | Reikwijdte | Snelheid | Dekking |
|------|-----------|-------|-------|----------|
| **Eenheid** | Jest/Vitest | Afzonderlijke functies/componenten | Snel | Hoog |
| **Integratie** | Jest + Prisma | Meerdere componenten die samenwerken | Middel | Middel |
| **Contract** | Supertest | API-contracten en responses | Snel | Middel |
| **E2E** | Playwright | Volledige gebruikersworkflows | Langzaam | Laag |
...
#### Voorbeeld: Test service-eenheid
...
Integratietests gebruiken een testdatabase en testen echte database-interacties.

#### Database-instellingen testen
...
Contracttests verifiëren de API-responsstructuur en gegevenstypen.
...
### Vitest-configuratie (`vitest.config.ts`)
...
#### Voorbeeld: Spelers bekijken test
...
### 5. Externe afhankelijkheden bespotten
...
- Vertrouw niet op de volgorde van testuitvoering
- Ruim na elke test op
- Gebruik transacties voor databasetests

### 7. Betekenisvolle beweringen
...
#### 3. Problemen met de databaseverbinding
