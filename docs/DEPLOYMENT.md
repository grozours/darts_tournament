...
This guide covers deploying the Darts Tournament Manager application from development to production environments.
...
Create `/etc/nginx/sites-available/darts_tournament`:
